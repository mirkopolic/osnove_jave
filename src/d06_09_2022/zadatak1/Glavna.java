...
public class Glavna {
	...
	public static void main(String[] args) {
		...
		Tetrapak t5 = new Tetrapak("323122-56511", "Sok 1l", 0.36, 0.46, true, 170.21);
		...
		StaklenaAmbalaza s4 = new StaklenaAmbalaza("444567-98785", "Pivo", 3.96, 6.22, 0.00, false, 233.50);
		StaklenaAmbalaza s5 = new StaklenaAmbalaza("444567-98766", "Rakija", 4.96, 5.22, 0.00, false, 133.50);
